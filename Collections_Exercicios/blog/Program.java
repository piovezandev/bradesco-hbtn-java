...
public class Program {
    public static void main(String[] args) {
        ...
        Post post2 = new Post("John Bannons", 
            ...
            "A interface Set � implementada por v�rias cole��es em Java bla bla bla",
            "Desenvolvimento");            
        ...
        Post post4 = new Post("Jane Doe", 
            "Azure Service Bus por onde come�ar",
            "Primeiramente, � necess�rio entender que bla bla bla",
            "DevOps");
